    ...
    <el-row>
      ...
      <el-col :lg="12" :md="12" :sm="24" :xl="8" :xs="24">
        <el-form ref="form" class="login-form" label-position="left" :model="form" :rules="rules">
          ...
          <el-form-item prop="verifyCode" style="margin-top: 40px">
            <el-input v-model.trim="form.verifyCode" v-focus placeholder="请输入验证码" style="width: 60%" tabindex="1" type="text" />
          </el-form-item>
...
<script>
  import { isPassword, isVerifyCode } from '@/utils/validate'
